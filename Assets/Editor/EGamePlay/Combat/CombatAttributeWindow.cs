...
namespace EGamePlay.Combat {
    ...
    public class CombatAttributeWindow : OdinEditorWindow {
        ...
        [LabelText("属性配置")] [ListDrawerSettings(Expanded = true, DraggableItems = false)]
        ...
        [OnInspectorGUI(AppendMethodName = "DrawStateList" /*, AppendMethodName = "EndDrawStateMatrix"*/)] [LabelText("状态配置")] [ListDrawerSettings(Expanded = true, DraggableItems = false)]
