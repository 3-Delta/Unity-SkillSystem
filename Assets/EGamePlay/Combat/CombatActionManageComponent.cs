...
namespace EGamePlay.Combat {
    ...
    public class CombatActionManageComponent : Component {
        private List<ActionAbilityExecution> CombatActions = new List<ActionAbilityExecution>();

        public T CreateAction<T>(CombatEntity combatEntity) where T : ActionAbilityExecution {
