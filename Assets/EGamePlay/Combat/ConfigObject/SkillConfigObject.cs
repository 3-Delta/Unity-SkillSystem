...
namespace EGamePlay.Combat {
...
#endif
    {
        [LabelText("技能ID"), DelayedProperty] public int Id;
        [LabelText("技能名称"), DelayedProperty] public string Name = "技能1";
        ...
        public bool ShowCircleAreaRadius {
            get { return AffectAreaType == SkillAffectAreaType.Circle && TargetSelectType == SkillTargetSelectType.AreaSelect; }
        }
        ...
        [LabelText("附加状态效果")] public bool EnableChildrenStatuses;

        [OnInspectorGUI("DrawSpace", append: true)] [HideReferenceObjectPicker] [LabelText("附加状态效果列表"), ShowIf("EnableChildrenStatuses"), ListDrawerSettings(DraggableItems = false, ShowItemCount = false, CustomAddFunction = "AddChildStatus")]
        ...
        [LabelText("效果列表"), Space(30)] [ListDrawerSettings(Expanded = true, DraggableItems = true, ShowItemCount = false, HideAddButton = true)] [HideReferenceObjectPicker]
        public List<Effect> Effects = new List<Effect>();

        [HorizontalGroup(PaddingLeft = 40, PaddingRight = 40)] [HideLabel] [OnValueChanged("AddEffect")] [ValueDropdown("EffectTypeSelect")]
...
#if !SERVER
        [OnInspectorGUI("BeginBox", append: false)] [LabelText("技能执行")]
        public GameObject SkillExecutionAsset;

        [LabelText("技能音效")] [OnInspectorGUI("EndBox", append: true)]
        public AudioClip SkillAudio;

        [TextArea, LabelText("技能描述")] public string SkillDescription;
#endif

#if UNITY_EDITOR
        [SerializeField, LabelText("自动重命名")]
        public bool AutoRename {
            get { return StatusConfigObject.AutoRenameStatic; }
            set { StatusConfigObject.AutoRenameStatic = value; }
        }
    ...
    public enum ShieldType {
        [LabelText("普通护盾")] Shield,
        [LabelText("物理护盾")] PhysicShield,
        [LabelText("魔法护盾")] MagicShield,
        [LabelText("技能护盾")] SkillShield,
    }

    [LabelText("标记类型")]
    public enum TagType {
        [LabelText("能量标记")] Power,
    }
}